    ...
    <section id="about" style={{ marginTop: "2rem" }}>
      ...
      >
              ...
              <Grid item size={{xs:12,sm:6,md:3}} key={index}>
                <Paper
                  ...
                  sx={{
                    ...
                    height: "100%", // 🎯 hace que todas las cards midan igual
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  {Icon && (
                    <Icon
                      sx={{ fontSize: 40, mb: 2, color: config.colors.primary }}
                    />
                  )}
        ...
        <Grid container spacing={4} mt={6}>
          {[aboutUsSectionConfig.mission, aboutUsSectionConfig.vision].map(
            (section, idx) => {
              const Icon = iconMap[section.iconName]; // 🎯 también dinámico
              return (
                <Grid item size={{xs:12,md:6}} key={idx}>
                  ...
                  >
                    ...
                    <Typography variant="body1" sx={{ color: config.colors.textSecondary }}>
                      {section.text}
                    </Typography>
                  </Paper>
                </Grid>
